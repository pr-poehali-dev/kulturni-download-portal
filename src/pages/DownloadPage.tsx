...
const DownloadPage = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <h1 className="text-3xl md:text-4xl font-bold text-center mb-8 kulturni-text">
        Скачать Kulturni.cc
      </h1>
      
      <div className="grid md:grid-cols-2 gap-8 mb-10">
        <Card className="bg-kulturni-muted border-kulturni-border shadow-md hover:shadow-lg transition-shadow">
          <CardHeader>
            <CardTitle className="flex items-center gap-2 text-kulturni-accent">
              <Shield className="h-5 w-5" />
              Безопасность
            </CardTitle>
            <CardDescription className="text-kulturni-foreground">
      ...
      <Card className="mb-8 bg-kulturni-muted border-kulturni-border shadow-lg kulturni-glow">
        <CardHeader>
          <CardTitle className="text-kulturni-foreground">Последняя версия: v1.2.5</CardTitle>
          <CardDescription className="flex items-center gap-1">
            <span>Обновлено:</span> <Clock className="inline h-4 w-4 mb-1" /> <span>15.09.2023</span>
          </CardDescription>
        </CardHeader>
        <CardContent>
          <h3 className="text-lg font-medium mb-2 text-kulturni-accent">Что нового:</h3>
          ...
          <h3 className="text-lg font-medium mb-2 text-kulturni-accent">Системные требования:</h3>
        ...
        <CardFooter className="flex justify-center">
          <Button 
            size="lg" 
            className="kulturni-button w-full sm:w-auto"
      ...
      <div className="bg-kulturni-muted p-6 rounded-lg border border-kulturni-border">
        <h2 className="text-xl font-bold mb-4 text-kulturni-accent">Инструкция по установке:</h2>
